...
gov_train_diff, gov_test_diff, gov_train_labels, gov_test_labels = train_test_split(gov_diff, gov_labels, test_size=0.2, random_state=35)
sen_train_diff, sen_test_diff, sen_train_labels, sen_test_labels = train_test_split(sen_diff, sen_labels, test_size=0.2, random_state=5)
