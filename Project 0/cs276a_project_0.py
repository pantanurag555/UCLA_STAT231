# -*- coding: utf-8 -*-
"""CS276A: Project 0.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1CxY3E2mYcNue8fjFuIgvpsgwHCgQBSYg
"""
...
#     # only block 1 and block 5  
#     conv_w1 = tf.Variable(kaiming_normal([5, 5, 3, 32]))
#     conv_b1 = tf.Variable(tf.zeros(32,))

#     # only block 1, block 2 and block 5  
#     conv_w1 = tf.Variable(kaiming_normal([5, 5, 3, 32]))
#     conv_b1 = tf.Variable(tf.zeros(32,))
...
#     # only block 1, block 2, block 3 and block 5  
#     conv_w1 = tf.Variable(kaiming_normal([5, 5, 3, 32]))
#     conv_b1 = tf.Variable(tf.zeros(32,))
...
#     params = [conv_w1, conv_b1, conv_w2, conv_b2, conv_w3, conv_b3, conv_w5, conv_b5]    # only block 1, block 2, block 3 and block 5  
#     params = [conv_w1, conv_b1, conv_w2, conv_b2, conv_w5, conv_b5]    # only block 1, block 2 and block 5
#     params = [conv_w1, conv_b1, conv_w5, conv_b5]    # only block 1 and block 5
...
#     [conv_w1, conv_b1, conv_w5, conv_b5] = params    # only block 1 and block 5
#     [conv_w1, conv_b1, conv_w2, conv_b2, conv_w5, conv_b5] = params    # only block 1, block 2 and block 5
#     [conv_w1, conv_b1, conv_w2, conv_b2, conv_w3, conv_b3, conv_w5, conv_b5] = params    # only block 1, block 2, block 3 and block 5  
...
#     x5_1_conv = tf.nn.conv2d(x3_5_pool, conv_w5, [1, 1, 1, 1], padding='VALID') + conv_b5    # only block 1, block 2, block 3 and block 5  

#     x5_1_conv = tf.nn.conv2d(x2_5_pool, conv_w5, [1, 1, 1, 1], padding='VALID') + conv_b5    # only block 1, block 2 and block 5

#     x5_1_conv = tf.nn.conv2d(x1_5_relu, conv_w5, [1, 1, 1, 1], padding='VALID') + conv_b5    # only block 1 and block 5
